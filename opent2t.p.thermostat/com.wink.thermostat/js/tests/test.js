...
test.serial('GetAmbientTemperature', t => {
    return OpenT2T.invokeMethodAsync(translator, 'opent2t.p.thermostat', 'getDevicesAmbientTemperature', ['D5D37EB6-F428-41FA-AC5D-918F084A4C93'])
        .then((response) => {
...
test.serial('GetTargetTemperature', t => {
    return OpenT2T.invokeMethodAsync(translator, 'opent2t.p.thermostat', 'getDevicesTargetTemperature', ['D5D37EB6-F428-41FA-AC5D-918F084A4C93'])
        .then((response) => {
            t.is(response.rt[0], 'oic.r.temperature');
...
test.serial('SetAwayMode', t => {
    ...
    return OpenT2T.invokeMethodAsync(translator, 'opent2t.p.thermostat', 'postDevicesAwayMode', ['D5D37EB6-F428-41FA-AC5D-918F084A4C93', awayMode])
        .then((response) => {
...
test.serial('GetHumidity_Fails', t => {
    t.throws(OpenT2T.invokeMethodAsync(translator, 'opent2t.p.thermostat', 'getDevicesHumidity', ['D5D37EB6-F428-41FA-AC5D-918F084A4C93']),
        'NotImplemented');
...
test.serial('PostAwayTemperatureHigh_Fails', t => {
    ...
    t.throws(OpenT2T.invokeMethodAsync(translator, 'opent2t.p.thermostat', 'postDevicesAwayTemperatureHigh', ['D5D37EB6-F428-41FA-AC5D-918F084A4C93', awayTemperatureHigh]),
        'NotImplemented');
