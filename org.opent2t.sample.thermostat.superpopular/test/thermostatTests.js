...
function runThermostatTests(translatorPath, hubDevice, test, testData) {

    test.serial('AmbientTemperature', t => {
        return OpenT2T.createTranslatorAsync(translatorPath, 'thingTranslator', hubDevice).then(translator => {
    ...
    test.serial('TargetTemperatureHigh', t => {
        hubDevice.setTestData(testData.TargetTemperatureHigh, t);
        return OpenT2T.createTranslatorAsync(translatorPath, 'thingTranslator', hubDevice).then(translator => {
            return OpenT2T.getPropertyAsync(translator, 'org.opent2t.sample.thermostat.superpopular', 'targetTemperatureHigh').then((initialTemperatureHigh) => {
                return OpenT2T.setPropertyAsync(translator, 'org.opent2t.sample.thermostat.superpopular', 'targetTemperatureHigh', 22).then(() => {
                    return OpenT2T.getPropertyAsync(translator, 'org.opent2t.sample.thermostat.superpopular', 'targetTemperatureHigh').then((targetTemperatureHigh) => {
                        ...
                        t.not(targetTemperatureHigh, initialTemperatureHigh)
    ...
    test.serial('TargetTemperatureLow', t => {
        hubDevice.setTestData(testData.TargetTemperatureLow, t);
        return OpenT2T.createTranslatorAsync(translatorPath, 'thingTranslator', hubDevice).then(translator => {
    ...
    test.serial('TargetTemperatureHigh_TargetTemperatureLow_Post_Get', t => {
        hubDevice.setTestData(testData.TargetTemperatureHigh_TargetTemperatureLow_Post_Get, t);
        return OpenT2T.createTranslatorAsync(translatorPath, 'thingTranslator', hubDevice).then(translator => {
    ...
    test.serial('PostThermostatResURI_Set_HvacMode', t => {
        ...
        hubDevice.setTestData(testData.PostThermostatResURI_Set_HvacMode, t);
    ...
    test.serial('PostThermostatResURI_Set_HvacMode_Off_Then_HeatOnly', t => {
        ...
        hubDevice.setTestData(testData.PostThermostatResURI_Set_HvacMode_Off_Then_HeatOnly, t);
        return OpenT2T.createTranslatorAsync(translatorPath, 'thingTranslator', hubDevice).then(translator => {
            return OpenT2T.invokeMethodAsync(translator, 'org.opent2t.sample.thermostat.superpopular', 'postThermostatResURI', [value]).then((response) => {
