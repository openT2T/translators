...
test.serial('GetAmbientTemperature', t => {
    return OpenT2T.invokeMethodAsync(translator, 'org.opent2t.sample.thermostat.superpopular', 'getDevicesAmbientTemperature', [controlId])
        .then((response) => {
...
test.serial('GetTargetTemperature', t => {
    return OpenT2T.invokeMethodAsync(translator, 'org.opent2t.sample.thermostat.superpopular', 'getDevicesTargetTemperature', [controlId])
        .then((response) => {
            t.is(response.rt[0], 'oic.r.temperature');
...
test.serial('GetHumidity', t => {
    ...
    return OpenT2T.invokeMethodAsync(translator, 'org.opent2t.sample.thermostat.superpopular', 'getDevicesHumidity', [controlId])
       .then((response) => {
...
test.serial('PostAwayTemperatureHigh_Fails', t => {
    ...
    t.throws(OpenT2T.invokeMethodAsync(translator, 'org.opent2t.sample.thermostat.superpopular', 'postDevicesAwayTemperatureHigh', [controlId, awayTemperatureHigh]),
        'NotImplemented');
