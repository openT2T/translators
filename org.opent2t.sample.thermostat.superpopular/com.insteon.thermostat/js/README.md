# Insteon Thermostat Translator
Translator for Insteon thermostat (https://insteon.com)

## Setup Your Hardware
Follow instructions in the Insteon app to set up your thermostat with Insteon. This is a pre-requisite
