# SmartThings Light Translator
Translator for SmartThings Light (https://smartthings.com)

## Setup Your Hardware
Follow instructions in the SmartThings app to set up your light with SmartThings. This is a pre-requisite
